  ...
  return (
    <div>
      ...
      >
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "38px", color: "#ffffff" }}>
            ...
            {usuario === "Zeggers" ? (
              ...
              paisInicial === "Bolivia" ? (
                ...
                bancoArs === "Mercado Pago" ? (
                  <p style={{ textAlign: "left", fontSize: "18px", lineHeight: "1.7" }}>
        ...
        <p style={{ fontSize: "10px", color: "#bbbbbb", textAlign: "center", marginTop: "18px" }}>
        ...
        <p className="text-[#bbbbbb] text-xs">#{codigo}</p>
      </div>
    </div>
  );
};
